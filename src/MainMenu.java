...
public class MainMenu {
    ...
    void showAuswertungenMenu() {
        ...
        while (!input.equals("g") && counter < RUNDENZAHL) {
            if (counter >= RUNDENZAHL) {
                // System.out.println("Keine Aktionen übrig");
                // infoMenu(true);
            } else {
                ...
                // TODO Auslagern und Fehlerbehandlung implementieren
                // repeat until input code is valid
                ...
                switch (input) {
                    ...
                    break;
                    case "c":
                    // Ausgabe angestellte Entwickler:innen gendern hier ja ist wichtig weil sonst
                    ...
                    case "e":
                        ...
                        System.out
                                .println("       Laufende Kosten: " + calculateCosts(gameDevStudio).toString() + "\n");
                        counter++;
                        break;
                    case "f":
                        // Ausgabe Tage bis Bankrott
                        double daysLeft = gameDevStudio.getCash().getValue().doubleValue()
                                / calculateCosts(gameDevStudio).getValue().doubleValue();
